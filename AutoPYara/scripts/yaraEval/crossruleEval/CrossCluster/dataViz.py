...
def loadData(pickle_file,csv_file):
    ...
    try:
        ...
        full_df = full_df.sample(frac=0.001)
...
if __name__ == '__main__':
    pklpath = [
        "/usr/src/app/YaraResults/ruleEval/originalBloomFilters/sdhash/AutoPYara/CrossCluster/BaseLine/Th50.pkl",
        "/usr/src/app/YaraResults/ruleEval/originalBloomFilters/sdhash/AutoPYara/CrossCluster/BaseLine/Th60.pkl",
        "/usr/src/app/YaraResults/ruleEval/originalBloomFilters/sdhash/AutoPYara/CrossCluster/BaseLine/Th70.pkl",
        "/usr/src/app/YaraResults/ruleEval/originalBloomFilters/sdhash/AutoPYara/CrossCluster/BaseLine/Th80.pkl",
        "/usr/src/app/YaraResults/ruleEval/originalBloomFilters/sdhash/AutoPYara/CrossCluster/BaseLine/Th90.pkl"
    ]
    
    csvpaths = [
        "/usr/src/app/YaraResults/clusterCSV/sdhash/Th50.csv",
        "/usr/src/app/YaraResults/clusterCSV/sdhash/Th60.csv",
        "/usr/src/app/YaraResults/clusterCSV/sdhash/Th70.csv",
        "/usr/src/app/YaraResults/clusterCSV/sdhash/Th80.csv",
        "/usr/src/app/YaraResults/clusterCSV/sdhash/Th90.csv"
    ]

    df = []
    
    # Create a new directory for saving DataFrames
    output_dir = Path("sdhash/")
    output_dir.mkdir(exist_ok=True)
    thres=['th50','th60','th70','th80','th90']
    df = []
    preloaded=True

    # Loop through pickle and CSV paths, load DataFrames, and save as CSV
    for pkl, csv ,threshold in zip(pklpath, csvpaths,thres):
