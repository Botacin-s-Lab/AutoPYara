...
if __name__ == "__main__":
    ...
    output_dir = "newtest/ssdeep/"
    run_with_varying_thresholds(csv_path, output_dir=output_dir, thresholds=[50,60,70,80,90], 
                                min_samples=2, noise_labeling='Ascending', max_files=None, num_cores=32)