...
OUTPUT_DIR = "vt_reports/vt_reports_UCSB.JP/"
FAILED_CSV = "vt_reports/vt_reports_UCSB.JP/failed_vt_queries.csv"
...
def process_csv(csv_path):
    try:
        ...
        results_df.to_csv('output/vt_report_paths_UCSB.JP.csv', index=False)
...
if __name__ == "__main__":
    process_csv("output/dataSet/UCSB.JP_pe_files.csv")
