...
def handle_softk_cluster(args):
    try:
        ...
        dir_path_skip=f'/usr/src/app/YaraResults/yaraRules/retrainedBloomFilters/sdhash/AutoPYara/Heuristics/Bad/MEAN/Th{TH}/cluster_{cluster}'
        ...
        cmd = [
            ...
            '--outputDirectory', f'/usr/src/app/YaraResults/yaraRules/retrainedBloomFilters/sdhash/AutoPYara/Heuristics/Bad/MEAN/Th{TH}/cluster_{cluster}',
            '--augmentedTarget_k'
