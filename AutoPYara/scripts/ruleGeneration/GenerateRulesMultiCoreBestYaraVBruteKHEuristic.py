...
def handle_softk_cluster(args):
    try:
        ...
        dir_path_skip=f'/usr/src/app/YaraResults/yaraRules/retrainedBloomFilters/sdhash/AutoPYara/Heuristics/Bad/Max/Th{TH}/cluster_{cluster}'
        ...
        cmd = [
            ...
            '--outputDirectory', f'/usr/src/app/YaraResults/yaraRules/retrainedBloomFilters/sdhash/AutoPYara/Heuristics/Bad/Max/Th{TH}/cluster_{cluster}',
            '--augmentedTarget_k'
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str, 
        required=True, 
        help='Threshold value (THV) for sdha1sh directory path'
    )
